...
module.exports = {
    ...
    run: function (toolbox) {
        return __awaiter(this, void 0, void 0, function () {
            var read, _a, run, which, _b, colors, info, table, padEnd, ignite, runtime, column1, column2, column3, platform, arch, cpus, firstCpu, cpu, cores, directory, nodePath, nodeVersion, _c, _d, npmPath, npmVersion, _e, yarnPath, yarnVersion, _f, rnPath, rnCli, _g, _h, _j, rnPkg, appReactNativeVersion, rnTable, ignitePath, igniteVersion, igniteJson, installedGenerators, igniteTable, androidPath, javaPath, javaVersionCmd, javaVersion, _k, _l, _m, _o, xcodePath, xcodeVersion, _p, _q, _r, cocoaPodsPath, cocoaPodsVersion, _s;
            return __generator(this, function (_t) {
                switch (_t.label) {
                    case 0:
                        read = toolbox.filesystem.read, _a = toolbox.system, run = _a.run, which = _a.which, _b = toolbox.print, colors = _b.colors, info = _b.info, table = _b.table, padEnd = toolbox.strings.padEnd, ignite = toolbox.ignite, runtime = toolbox.runtime;
                    ...
                    case 1:
                        nodeVersion = _c.apply(void 0, _d.concat([_t.sent()]));
                        npmPath = which('npm');
                        _e = npmPath;
                    ...
                    case 6:
                        _g = _h.apply(void 0, _j.concat([_t.sent()]))[1]; // lulz
                        _t.label = 7;
                    case 7:
                        rnCli = _g;
                    ...
                    case 9:
                        _k = _l.apply(void 0, [_m.apply(void 0, _o.concat([_t.sent()]))]);
                        _t.label = 10;
                    case 10:
                        javaVersion = _k;
                        info('');
                    ...
                    case 11:
                        _p = _q.apply(void 0, _r.concat([_t.sent()]))[1]; // lulz
                        _t.label = 12;
                    case 12:
                        xcodeVersion = _p;
                        info('');
                        ...
                        if (!cocoaPodsPath) return [3 /*break*/, 14];
