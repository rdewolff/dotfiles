...
declare type ComposeFnSync<Fns extends Tuple<Function>, K extends keyof Fns> = Length<Tail<Fns>> extends Format<K & string, 'n'> ? Fns[K] : Function<[// handling unknown generics, waiting for proposal
...
declare type ComposeFnAsync<Fns extends Tuple<Function>, K extends keyof Fns> = Length<Tail<Fns>> extends Format<K & string, 'n'> ? PromiseOf<Fns[K]> : Function<[// handling unknown generics, waiting for proposal
 ...
 * ```
 */
export declare type Composer<Fns extends Tuple<Function>, mode extends Mode = 'sync'> = {
    'sync': {
 ...
 */
export declare type Compose<Fns extends Tuple<Function>, mode extends Mode = 'sync'> = {
