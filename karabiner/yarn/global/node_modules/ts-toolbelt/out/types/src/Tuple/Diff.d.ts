 ...
 * ```
 */
export declare type Diff<T extends Tuple, T1 extends Tuple, match extends Match = 'default'> = TupleOf<(ODiff<ObjectOf<T>, ObjectOf<T1>, match>) extends infer X ? X & {} : never>;
