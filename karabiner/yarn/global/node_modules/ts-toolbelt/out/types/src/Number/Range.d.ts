...
declare type RangeForth<From extends Iteration, To extends Iteration, fmt extends Formats = 's', T extends Tuple = []> = {
    0: RangeForth<Prev<From>, To, fmt, Prepend<T, Format<From, fmt>>>;
    1: T;
}[From extends To ? 1 : 0];
declare type RangeBack<From extends Iteration, To extends Iteration, fmt extends Formats = 's', T extends Tuple = []> = {
