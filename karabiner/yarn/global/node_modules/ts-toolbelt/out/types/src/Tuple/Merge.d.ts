...
declare type MergeFlat<T extends Tuple, T1 extends Tuple> = T extends unknown ? T1 extends unknown ? (number extends Length<T | T1> ? (T | T1) extends (infer T)[] ? T[] : never : TupleOf<OMerge<ObjectOf<T>, Omit<ObjectOf<T1>, keyof T>>>) : never : never;
