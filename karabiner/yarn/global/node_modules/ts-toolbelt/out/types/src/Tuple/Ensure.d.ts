 ...
 * ```
 */
export declare type Ensure<T extends object> = number extends At<T, 'length'> ? [Exclude<keyof T, keyof any[] | Numbers['string']['+' | '0']>] extends [never] ? At<T, number>[] : T : Omit<T & [], keyof any[]>;
